...
class MylistView extends Component {
    ...
    _renderUnlink = (name) =>{
      ...
      var status = this.props.data.request_status;
        ...
        return(
            ...
            <CardItem cardBody>
              <Body style={styles.cardBody}>
                ...
                <Text style={styles.bodyText}>
                  <Text style={styles.boldText}>Status.: </Text>{this.props.data.request_status}</Text>
                </Body>
            </CardItem>
            <CardItem style={styles.CardItem}>
              <Body style={styles.ViewDetailsBodyStyle} >
                ...
                <TouchableOpacity style={[styles.textBack,{display:this._renderUnlink('Unlink')}]} onPress = {() => this.props.onLink(this.props.data)}>
