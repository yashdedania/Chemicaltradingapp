        ...
        return(
            ...
            <CardItem cardBody>
              <Body style={styles.cardBody}>
                ...
                <Text style={styles.bodyText}>
                  <Text style={styles.boldText}>Quantity :</Text> {this.state.screenname == "Purchase" ? this.props.data.extra_purchase_quantity:this.props.data.selling_quantity} MT </Text>
                {this.state.screenname == "Purchase" ? (
                  <Text style={styles.bodyText}>
                  <Text style={styles.boldText}>Pending Orders :</Text> Rs. {this.props.data.total_pending == null ? 0 : this.props.data.total_pending}/MT </Text>
                ):(null)}
                <Text style={styles.bodyText}>
