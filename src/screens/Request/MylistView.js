            ...
            <CardItem>
              ...
              <Right>
                <Body style={styles.DateTimeBody}>
                  <Text note style={styles.boldText}>Time : {format.Time(this.props.data.updatedAt)} </Text>
                  <Text note style={styles.boldText}>Date : {format.Date(this.props.data.updatedAt)}</Text>
                </Body>
              </Right>
            </CardItem>
            <CardItem cardBody>
              <Body style={styles.cardBody}>
                ...
                <Text style={styles.bodyText}>
                  <Text style={styles.boldText}>Quantity :</Text> {this.props.data.purchase_quantity} MT </Text>
                <Text style={styles.bodyText}>
                  <Text style={styles.boldText}>Amount :</Text> Rs. {this.props.data.total_amount} </Text>
                <Text style={styles.bodyText}>
                  <Text style={styles.boldText}>Supplier :</Text> {this.props.data.supplier} </Text>
                <Text style={styles.bodyText}>
