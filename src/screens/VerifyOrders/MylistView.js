        ...
        return(
            ...
            <CardItem cardBody>
              <Body style={styles.cardBody}>
                ...
                <Text style={styles.bodyText}>
                  <Text style={styles.boldText}>Quantity :</Text> {this.state.screenname == "Purchase" ? this.props.data.purchase_quantity:this.props.data.selling_quantity} MT </Text>
                <Text style={styles.bodyText}>
            ...
            <CardItem style={styles.CardItem}>
              <Body style={styles.ViewDetailsBodyStyle} >
                ...
                <TouchableOpacity style={styles.textBack} onPress = {() => this._onPress()}>
