...
class DPurchaseRequest extends Component {
        ...
        return(
            ...
            <ListItem thumbnail style={{flex:1,flexDirection:"row",margin:10}} onPress={() => this._onPressItem(item)}>
                ...
                <Body>
                    ...
                    <Text style={gstyles.textRegular}><Text style={gstyles.textBold}>Quantity:</Text> {item.purchase_quantity} MT </Text>
    ...
    render() {
        ...
        return(
            <Container style={this.state.searchBarFocused ? hstyles.blurBackground : null}>
                ...
                <PurchaseModal visibile={this.state.modalVisible} data={{...this.state.currentData}} dismiss={this._onDismiss} />
...
export default (connect(mapStateToProps)(DPurchaseRequest));