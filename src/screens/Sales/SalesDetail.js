    ...
    render(){
        ...
        return(
            ...
            <View style={styles.viewIconText}>
                ...
                {this.props.user.details.role == "admin" ? "Subtracted from Inventory" : "Request Sent"} 
                </Text>
            </View>
            ...
            <Content>
                ...
                <ListItem>
                    ...
                    <Body><Text style={styles.listitemstyle}>{this.state.linkid == null ? 'Not Linked(Purchase Pending)' : 'Linked to CC No.'+this.state.linkid}</Text></Body>
                </ListItem>
                ...
                <ListItem>
                    ...
                    <Body><Text style={styles.listitemstyle}>{this.state.storage.days} days from {format.Date(this.state.storage.date)}</Text></Body>
                </ListItem>
                ...
                <ListItem>
                    ...
                    <Body><Text style={styles.listitemstyle}>{this.state.broker.commission} PMT</Text></Body>
                </ListItem>
                }
                <ListItem>
                    <Left><Text>Selling To :</Text></Left>
